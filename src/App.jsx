            ...
            <ul className="products__list">
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo-2.jpg" alt="Кокосовая матча" />
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo-1.jpg" alt="Зеленый индонезийский чай" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo.jpg" alt="Черный чай из Эфиопии" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo-5.jpg" alt="Черный чай из Калифорнии" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo-4.jpg" alt="Органическая веганская матча" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__img" src="img/photo-3.jpg" alt="Чай черный Лакандона" />
                  <div className="product__content">
          ...
          <div className="footer__info">
            ...
            <ul className="footer__developers">
              <li className="footer__developer">
                Designer:
                <a className="footer_developer-link" href="">Anastasia Ilina</a>
              </li>
              <li className="footer__developer">
                Developer:
                <a className="footer_developer-link" href="https://github.com/alexeyKonstantinov78/">Aleksey Konstantinov</a>
              </li>
            </ul>
          </div>
