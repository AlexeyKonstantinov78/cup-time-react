  ...
  return (
    <footer className={s.footer}>
      <div className={`container ${s.footer__container}`}>
        <Link className={s.footer__logoLink} to='/'>
          <img
        ...
        <div className={s.footer__nav}>
          <ul className={s.footer__menu}>
            {categoryTitles.map((categoryTitle) => (
              <li key={categoryTitle.value} className={s.footer__menuItem}>
                <Link
                  className={s.footer__menuLink}
        ...
        <div className={s.footer__info}>
          ...
          <ul className={s.footer__developers}>
            <li className={s.footer__developer}>
              Designer:
              <a className={s.footer_developerLink} href='' target='_blank'>
                Anastasia Ilina
              </a>
            </li>
            <li className={s.footer__developer}>
              Developer:
              <a
                className={s.footer_developerLink}
        ...
        <div className={s.footer__contacts}>
          <a className={s.footer__email} href='mailto:CUPTIME@gmail.com'>
            CUPTIME@gmail.com
          </a>
          <ul className={s.footer__socials}>
            <li className={s.footer__socialItem}>
              <a className={s.footer_socialLink} href='#'>
                <svg
                  width='32'
                  height='32'
                  viewBox='0 0 32 32'
